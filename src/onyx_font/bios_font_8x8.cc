...
namespace onyx_font {
    namespace {
        // IBM CGA/EGA 8x8 BIOS font (CP437), 256 glyphs, 8 bytes per glyph.
        // Public domain — from IBM video BIOS ROM.
        // clang-format off
        constexpr std::array<std::uint8_t, 2048> k_vga_8x8 = {{
            ...
            // 0x80-0xFF: Extended CP437 (accented chars, box drawing, etc.)
            ...
            0xCC,0x00,0x78,0x0C,0x7C,0xCC,0x76,0x00, // 0x84 ä
            0xE0,0x00,0x78,0x0C,0x7C,0xCC,0x76,0x00, // 0x85 à
            0x30,0x30,0x78,0x0C,0x7C,0xCC,0x76,0x00, // 0x86 å
            0x00,0x00,0x7C,0xC6,0xC0,0x78,0x0C,0x38, // 0x87 ç
            ...
            0xF8,0xCC,0xCC,0xFA,0xC6,0xCF,0xC6,0xC7, // 0x9E Pt
            0x0E,0x1B,0x18,0x3C,0x18,0x18,0xD8,0x70, // 0x9F ƒ
            0x1C,0x00,0x78,0x0C,0x7C,0xCC,0x76,0x00, // 0xA0 á
    ...
    const bitmap_font& bios_font_8x8() {
        static const bitmap_font font = font_factory::load_raw(
            std::span<const std::uint8_t>(k_vga_8x8.data(), k_vga_8x8.size()),
            raw_font_options::vga_8x8());
        return font;
    }
